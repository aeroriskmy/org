...
const subCourses = [
    {
        title: 'Logistic in Aviation: The Impact of IoT in Enhancing Operations Performance Seminar',
        about: 'This seminar provides comprehensive knowledge the impact of IOT to the air cargo sector. It creates familiarization with the technologies that enhances performance and efficiency and encourages adaptation and implementation of the latest methods in order to sustain and be competitive and tackle challenges in the industry. This is an online seminar for two days and a total of 7 hours. Participants will be awarded with the certificate of attendance at the end of the seminar.',
        duration: '2 Days',
        commencement: 'CLICK HERE'
    }
];

export default function LogisticsInAviationPage() {
    return (
