...
const subCourses = [
    {
        title: 'Risks and Liabilities in Aircraft MRO Operations Seminar',
        about: 'Poor aviation maintenance, maintenance errors or maintenance negligence are commonly found to be one of the top three causes of aviation maintenance accidents. This online seminar will provide a clear and comprehensive knowledge on how to manage risks and liabilities and to ensure smooth operations in maintaining quality and productivity. Participants will be awarded with the certificate of attendance at the end of the seminar.',
        duration: '2 days',
        commencement: 'CLICK HERE'
    },
    {
        title: 'Lean Six Sigma in Aircraft MRO Operations Seminar',
        about: 'The changes in the technology is significantly impacting the industry to adopt and adapt new methods from a more conservative approach to operations to latest and high tech approach. Will the conventional style is still being utilized or is the new approaches are being applied? Therefore the implementation of a Lean Six Sigma framework to enhance operational performance in MRO facility Processes are considered to be essential in the successful managing of performance and productivity The increasing need for Maintenance Repair Overhaul (MROs) organisations to meet customers’ demands in quality and reduced lead times / TATs is key to its survival within the Aviation industry. Participants will be awarded with certificate of attendance at the end of the seminar.',
        duration: '2 days',
        commencement: 'CLICK HERE'
    }
];

export default function MROOperationsPage() {
    return (
        <main className="bg-slate-950 min-h-screen relative overflow-hidden">
            ...
            <section className="relative pt-64 pb-24 overflow-hidden">
                <div className="container mx-auto px-4 relative z-10 text-center text-white pt-12">
                    ...
                    >
                        Aircraft Maintenance, Repair<br />and Overhaul (MRO) Operations
                    </motion.h1>
