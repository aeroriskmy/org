...
const subCourses = [
    {
        title: 'Risk & Liabilities in Airlines & Airport Operations Seminar',
        about: 'Airlines and airport operations covers the entities which operates and provides air services and facilities at airports, including airport owners & operators, hangar keepers ,air traffic control services, maintenance, repair and service facilities, aircraft refuellers ,security service providers, flying clubs and schools. The risks that are exposed to the airlines and airport operators are huge and the consequences are significant. Knowing and understanding on the risks would entail to effective crisis management. Participants are awarded certificate of attendance at the end of the seminar',
        duration: '2 Days',
