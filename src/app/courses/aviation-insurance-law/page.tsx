...
const subCourses = [
    {
        title: 'Aviation Insurance Law : Clauses, Endorsement, Policy Wordings and Exclusion Seminar',
        about: 'Aviation insurance is complex and technical. It requires detailed understanding of the policy wordings and how it works. The main objective of this seminar is to give an overview of what constitutes clear and certain policy wordings in aviation insurance that are not understood only by an insurance expert but also by the common man or woman. Participants will be awarded with the certificate of attendance at the end of the seminar.',
        duration: '2 Days',
        commencement: 'June 2021'
    }
];

export default function AviationLawPage() {
    return (
