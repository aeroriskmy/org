        ...
        <section id="courses" className="section relative overflow-hidden bg-slate-950 py-24">
            ...
            <div className="container mx-auto px-4 relative z-10" ref={ref}>
                ...
                >
                    <Link
                        href="/courses"
                        className="inline-flex items-center gap-2 px-8 py-4 bg-[#d4a853] text-black font-bold rounded-full hover:bg-[#b08833] transition-all duration-300 hover:gap-4 shadow-lg shadow-[#d4a853]/20"
                    >
                        View All Courses
